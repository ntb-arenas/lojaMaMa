...
<form  action="./userGerirUtilizadores.php#ancoraTopo" method="POST">
      ...
      <button type="submit" name="botao-refresh-users-asc"> Atualizar</button>
...
<br>
  ...
  <form action="./userGerirUtilizadores.php#ancoraTopo" method="POST">
                ...
                <button name="botao-pesquisar-lista-utilizadores" type="submit">Pesquisar</button>
  </form>   
...
<br>
  ...
  <form action="./userGerirUtilizadores.php#ancoraTopo" method="POST">
                ...
                <button name="botao-exportar-contactos" type="submit">Exportar contactos (CSV)</button>
                <input id="filtroSQL" name="filtroSQL" type="hidden" value="<?php echo $filtroSQL; ?>"> 
  </form>   
