...
<form action="#" method="POST">
  ...
  <input type="text" id="formCodigo" name="formCodigo" value="<?php echo $codigo;?>">
  <?php echo $mensagemErroCodigo;?>
  <br><br>
  
  <label for="formEmail">e-Mail:</label><br>
  <input type="text" id="formEmail" name="formEmail" value="<?php echo $email;?>">
  <?php echo $mensagemErroEmail;?>
  <br><br>
  
  <label for="formSenha1">Senha:</label><br>
  <input type="password" id="formSenha1" name="formSenha1" value="<?php echo $senha;?>">
  <?php echo $mensagemErroSenha;?>
  <br><br>
  
  <label for="formSenha2">Confirmação de senha:</label><br>
  <input type="password" id="formSenha2" name="formSenha2" value="<?php echo $senhaConfirmacao;?>">
  <?php echo $mensagemErroSenhaRecuperacao;?>
  <br><br>

  <label for="formNome">Nome completo:</label><br>
  <input type="text" id="formNome" name="formNome" value="<?php echo $nome;?>">
  ...
  <input type="submit" value="Criar conta" id="submit-criar-conta" name="submit-criar-conta">
  <input type="submit" value="Cancelar" id="submit-cancelar-conta" name="submit-cancelar-conta">
