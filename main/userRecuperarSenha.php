    ...
    ?>
        ...
        <form action="#" method="POST">
            ...
            <p>Introduza o código que utiliza para inciar sessão e carregue no botão para recuperar senha. Será enviada para o seu e-mail uma mensagem com um código de recuperação de senha.
                <br> Por vezes estas mensagens são consideradas correio não solicitado. Se não vir a mensagem de recuperação verifique o seu correio não solicitado (SPAM).
            </p>
            <br>
            <p> </p>
            ...
            <button name="botao-recuperar-senha" type="submit" class="submit"> Recuperar senha agora</button>
        </form>
