...
<body>
    <main>
        ...
        <nav class="mx-3 mt-3" aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active text-warning" aria-current="page">
                    <a class="text-decoration-none text-warning" href="./userCreateAccount.php">Criar uma conta</a>
                </li>
            </ol>
        </nav>
            ...
            <h2>Criar uma conta</h3>
                ...
                ?>
                    <form action="#" method="POST">
                        ...
                        <button class="btn btn-customized mt-3" name="submit-create-account" type="submit">CRIAR CONTA <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-door-open" viewBox="0 0 16 16">
        ...
        <footer class="p-3 mt-3" style="background-color: rgb(224, 224, 224);">
            <div class="container-fluid p-0">
                <div class="row">
