...
<body>
    <main>
        ...
        <footer class="p-3 d-none d-md-block mb-5" style="background-color: rgb(224, 224, 224);">
        ...
        <footer class="list-group w-100 p-3 d-md-none mb-5 mb-sm-1" style="background-color: rgb(224, 224, 224);">
            <a href="./index.php">
                <img class="img-fluid col-5 col-sm-4 col-md-3" src="gallery/logo.png" alt="Ma-ma logo" class="logo">
            </a>
            <h4 style="color: #ff7b46;">Apoio Comercial</h4>
